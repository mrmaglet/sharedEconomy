...
export function H3(props: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3
      {...props}
      className={cn(props.className, "scroll-m-20 text-2xl font-semibold tracking-tight")}
    >
      {props.children}
    </h3>
  )
...
export function Large(props: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn(props.className, "text-lg font-semibold")}>{props.children}</div>
}
...
export function List(props: React.HTMLAttributes<HTMLUListElement>) {
  return (
    <ul className={cn(props.className, "my-6 ml-6 list-disc [&>li]:mt-2")}>{props.children}</ul>
  )
}
...
export function Quote(props: React.HTMLAttributes<HTMLQuoteElement>) {
  return (
    <blockquote
      {...props}
      className={cn(props.className, "mt-6 border-l-2 pl-6 italic text-muted-foreground")}
    >
      {props.children}
    </blockquote>
  )
